...
def upgrade() -> None:
    ...
    # Create sub_orchestrators table
    op.create_table(
        'sub_orchestrators',
        sa.Column('id', sa.UUID(), nullable=False),
        sa.Column('director_id', sa.UUID(), nullable=False),
        ...
        sa.Column('last_activity_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
        sa.ForeignKeyConstraint(['director_id'], ['director_agents.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['current_task_id'], ['swarm_sub_tasks.id'], ondelete='SET NULL'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['assigned_orchestrator_id'], ['sub_orchestrators.id'], ondelete='SET NULL'),
        sa.PrimaryKeyConstraint('id')
    )
